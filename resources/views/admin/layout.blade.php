...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Privas Akun -->
            <li class="nav-item {{ request()->is('admin/privasi akun') ? 'active' : ''}}">
                <a class="nav-link" href="/admin/privasi akun">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Privasi Akun</span></a>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Armila Hasibuan</span>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Web Armila 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
